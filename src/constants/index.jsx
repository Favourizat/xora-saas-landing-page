export const features = [
  {
    ...
    title: "Work Smarter, Create Better",
    text: "Say goodbye to time-consuming editing. Xora AI Video Editor automates repetitive tasks and simplifies complex workflows, so you can spend less time editing and more time creating.",
    button: {
  ...
  },
  {
    ...
    title: "Rest Easy, We've Got Your Back",
    text: "Your privacy and data security come first. With advanced encryption and robust security measures, Xora Video Editor keeps your files and personal information safe at every step.",
    button: {
